...
import { bookingExpectations } from "@/lib/content";
...
export const alt = "Book a Call with Capstone";
    ...
    (
      <div
        style={{
          ...
          padding: "56px",
          background:
            "linear-gradient(135deg, rgba(198,165,107,0.28), rgba(17,17,16,1) 54%, rgba(127,145,136,0.22) 100%)",
          color: "#f3f0e8",
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 840 }}>
          ...
          >
            Use the discovery call to clarify the real problem, the best next step, and the
            right scope before committing.
          </div>
        </div>
